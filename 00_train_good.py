...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(dirs):
        ...
        model_file_path = "{model}/model_{machine_type}_good.hdf5".format(model=param["model_directory"],

                                                                          machine_type=machine_type)
        history_img = "{model}/history_{machine_type}_good.png".format(model=param["model_directory"],
                                                                       machine_type=machine_type)
